...
#'
#' @description Checks if the arguments of the \code{\link{PEC.binom.exact}} function are correctly specified.
#'
#' @usage check.PEC.binom.exact(n, alpha1, beta1, alpha2, beta2, alphaD, betaD, v, q, M, plot)
#'
...
check.PEC.binom.exact = function(n, alpha1, beta1, alpha2, beta2, alphaD, betaD, v, q, M, plot){
